...
<Note>
  With the release of `v0.9.0`, we have added in-Postgres analytics support to
  `pg_lakehouse` and rebranded it to `pg_analytics`. You can read more about the
  new release [here](TODO).
</Note>
