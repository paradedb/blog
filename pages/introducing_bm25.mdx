...
"og:image": "https://raw.githubusercontent.com/paradedb/paradedb/main/docs/images/bm25.png"
---

<img height="300" src="/images/bm25.png" noZoom />
...
`pg_bm25` is ready for use today. There are two ways to try it: [installing it](https://github.com/paradedb/paradedb/tree/dev/pg_search#installation) inside an existing, self-hosted Postgres instance,
