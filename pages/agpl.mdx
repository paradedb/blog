---
title: Why We Picked AGPL
description: By Philippe Noel
---
...
ParadeDB has been licensed under the GNU Affero General Public License 3.0 — also known as AGPLv3 — from day one. We reached this decision after evaluating four licenses and interviewing dozens of other open source companies. Since then, we’ve received many questions about our license. We’ve decided to detail our thought process and offer up a case study on why we picked AGPL.
...
ParadeDB is an open-source Elasticsearch alternative built on Postgres. The advice we’re about to share is most applicable companies like us: startups aiming to build a sustainable business on top of open source.

## Why the Right License Matters

First, we’re not lawyers. This is not legal advice. With this out of the way, we see open-source licenses as a contract among authors, community contributors, and users. By defining what each party can expect when they use, modify, or distribute a project, the license facilitates successful cooperation among strangers.

The license is also one of the first things developers read after discovering a new project. First impressions matter and the license shapes how developers perceive the project’s goals, which affects whether they feel compelled to contribute and join the community. 
...
3. **Be community-driven**. We wanted our project to be true open-source with a license approved by the Open Source Initiative (OSI). We believe that approved licenses incentivize developers to contribute to a project. We’ve also seen many projects with unapproved or very restrictive licenses get forked, which fragments the project’s community.
...
- **Eventually permissive**: Business Source License (BSL)
- **Copyleft permissive**: AGPL
- **Non-permissive**: Elastic License 2.0 (ELv2)
...
We liked the defensibility that ELv2 provides and its rising popularity. Since its inception in 2021, ELv2 has been adopted by projects like Airbyte, MindsDB, and Apollo GraphQL.
...
Over the past few months, we have been contacted by several Apache-licensed projects who want to integrate with ParadeDB but are worried about licensing conflicts with AGPL. To address these concerns, we issued commercial licenses to these companies (please [contact us](https://www.notion.so/Why-We-Picked-AGPL-Ming-Edit-e1c8b1f5acbe4395bfd9988c4a6e8ae1?pvs=21) if you’re interested in doing the same).
...
- **Open source traction**. ParadeDB has gained 5K stars in the past year, making it one of the fastest-growing open source database projects. We have an active community of members and contributors.
- **Usage**. ParadeDB has been deployed 40K times and is used by several Fortune 1000 companies.
- **Defensibility**. We have been contacted by and are working with several large cloud providers to integrate ParadeDB with their managed Postgres service.
...
We invite you to check out our [GitHub repo](https://github.com/paradedb/paradedb) to learn more or to join our [**Slack community**](https://join.slack.com/t/paradedbcommunity/shared_invite/zt-2lkzdsetw-OiIgbyFeiibd1DG~6wFgTQ) if you have any questions. And please don’t hesitate to show your support by [**giving us a star**](https://github.com/paradedb/paradedb)!