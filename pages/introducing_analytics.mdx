---
title: "pg_analytics: Transforming Postgres into an OLAP Database"
---
...
<Card title="Relative Query Time">
  ...
  <img
    height="300"
    src="/images/clickbench_time.png"
    noZoom
    className="mt-1"
  />
</Card>
...
The core ParadeDB team is focused on making `pg_analytics` production-ready. Combined with `pg_bm25`, our 
