...
<Note>
  ...
  of `pg_analytics` supersedes the version of `pg_analytics` described in this
  post. Read the official announcement [here](TODO).
</Note>

<Note>
  With the release of `v0.7.0`, we have deprecated `pg_analytics` in favour of
  `pg_lakehouse`. You can read more about our decision
  [here](https://x.com/philippemnoel/status/1806334397106336054).
</Note>
